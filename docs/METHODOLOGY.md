...
| **Hybrid** | **0.0257%** | **0.0192%** | **0.0505%** | **113.95s** | **0.93×** |

The hybrid method achieves 0.0257% mean pricing error—13× better than pure L-BFGS and 196× better than FFN-only—while taking similar time to L-BFGS (114s vs 106s). The FFN warm start guides L-BFGS to a superior local minimum, achieving exceptional accuracy at the cost of slightly longer runtime.
